...
CREATE TABLE topics (
    ...
    estimated_retention DOUBLE PRECISION DEFAULT 100.0,
...
CREATE TABLE journals (
    ...
    energy INT,
    mood INT,
    hours_studied DOUBLE PRECISION DEFAULT 0,
    achievements TEXT,
    challenges TEXT,
    lessons TEXT,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE leetcode_snapshots (
    ...
    easy_beats_pct DOUBLE PRECISION,
    medium_beats_pct DOUBLE PRECISION,
    hard_beats_pct DOUBLE PRECISION,
    ranking INT,
