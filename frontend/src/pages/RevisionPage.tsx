  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <KpiCard icon={<TrendingUp className="h-5 w-5 text-green-400" />} value={todayRevisions?.length ? 'Due' : 'Clear'} label="Status" tooltip={(todayRevisions?.length ?? 0) > 0 ? 'Revisions are due today.' : 'No revisions due — you are on track.'} />
      </div>
